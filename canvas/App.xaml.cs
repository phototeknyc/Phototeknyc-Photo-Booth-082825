...
namespace Photobooth
{
	...
	public partial class App : Application
	{
		...
		//		ServiceProvider.Branding = new Branding();
		...
		////	_basemainwindow = new MVVM.Views.Windows.MainWindow();
		...
		//	{
		//		MVVM.Views.Windows.MainWindow wnd = new MVVM.Views.Windows.MainWindow();
		//		wnd.ShowDialog();
		//	}
		...
		//			//wnd.ShowDialog();
		//			MessageBox.Show("Application crash " + e.Exception.Message, TranslationStrings.LabelApplicationError,
		//							MessageBoxButton.OK,
